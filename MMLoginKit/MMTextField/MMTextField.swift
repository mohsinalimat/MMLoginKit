...
/**
 An MMTextField is a subclass of the MMTextFieldEffects object, is a control that displays an UITextField with a customizable visual effect around the lower edge of the control.
 */
@IBDesignable class MMTextField: MMTextFieldEffects {
